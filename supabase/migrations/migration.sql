...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Wrsp9Lo+8RXWeW6hGbcKug==$/XuRyWJRzR0RpR9MA+D15SxOMJKZseIAQgWb+ViQpUs=:jIIadU40xC8VbCKH73lEBnaMYjdfQlnpBPWYJUmylqo=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Oy/Y5CgD5MxAxddQF914qg==$1/A5ltULG6CEQgL/ofK03OLP3k9q7Pa5+eFyuOkZNGM=:4VOuV/i91iJ2IHfdsAKVYqU0IU9TVoDjW98IL/atkKQ=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:zoVL3xbyGu/sgGfMWLqLxA==$FpU+L8TXWcuo3O8WMiLFNjeqzTeox+dPMyOQqH2v6FA=:tovZrRnvIOGFJG4bulrdw+FXFvU/EpAjwHI+aqJo/GU=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:UGh5GDXNa8S8SZ+83oRgTg==$+PSlIefnariLT5Dw0rFJkozlVK52hZb1uoeTOXBRDNg=:gzTXjw8bij/N+hYOuAiSMtoGEZkBmzZwOOt6raWWgZY=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:YpYgDULpTfnS+MXk8bEwUw==$4Unhnkz3P0hQupQWDNZtrteQiaBjoZuAZ6BIVHt5ei8=:EkWNnaHYgIxl5nSy6bbhhdPiCBQaGIcYMt7Gc33M06A=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:NJJEMU9hLssTF2US4TCVYA==$dVSOT7ugUKsbEJJy2aPxp2meE3SlEd6yVAM6BfAFcRQ=:0CYWNREde8vYz+iyFoIWfP1M71MW/GpzaiAOF/j3D9k=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:RRzyPCizRPejEQJbLX1WKA==$Td42pNEaaDje08IbB9g50D1VlMgzYVNmmmNc3f2rvv0=:Hpv0KcYq72vKetu0mAWn2BY0mHqkLWbnA4kNgFtbbNY=';
...
--
-- Name: data_logs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."data_logs" (
    ...
    "timestamp" bigint NOT NULL,
    CONSTRAINT "data_logs_direction_check" CHECK (("direction" = ANY (ARRAY['RX'::"text", 'TX'::"text"])))
);
...
--
-- Name: thermal_frames; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."thermal_frames" (
    "id" "text" NOT NULL,
...
--
-- Name: thermal_recordings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."thermal_recordings" (
    "id" "text" NOT NULL,
    "device_id" "text" NOT NULL,
    "device_name" "text",
    "name" "text" NOT NULL,
...
--
-- Name: data_logs data_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: thermal_frames thermal_frames_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."thermal_frames"
    ADD CONSTRAINT "thermal_frames_pkey" PRIMARY KEY ("id");


--
-- Name: thermal_recordings thermal_recordings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."thermal_recordings"
    ADD CONSTRAINT "thermal_recordings_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_alerts_device" ON "public"."alerts" USING "btree" ("device_id");


--
-- Name: idx_data_logs_device; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_data_logs_device" ON "public"."data_logs" USING "btree" ("device_id");


--
-- Name: idx_thermal_frames_rec; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_thermal_frames_rec" ON "public"."thermal_frames" USING "btree" ("recording_id", "frame_index");


--
-- Name: idx_thermal_rec_device; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_thermal_rec_device" ON "public"."thermal_recordings" USING "btree" ("device_id");
...
--
-- Name: thermal_frames thermal_frames_recording_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."thermal_frames"
    ADD CONSTRAINT "thermal_frames_recording_id_fkey" FOREIGN KEY ("recording_id") REFERENCES "public"."thermal_recordings"("id") ON DELETE CASCADE;
